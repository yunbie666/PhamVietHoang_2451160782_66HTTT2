...
Thẻ  section: dùng để chia các khu vực nội dung, ví dụ như hiển thị thông tin trạng thái đơn hàng
Thẻ footer : nằm ở cuối trang, chứa thông tin liên hệ và các chính sách
![Network request](screenshots/b4-1.1.png)
![Network request](screenshots/b4-1.2.png)
![Network request](screenshots/b4-1.3.png)

Các thẻ semantic giúp cấu trúc trang rõ ràng và dễ hiểu hơn cho trình duyệt
